import {
  ...
  AppKitConnectButton,
  AppKitNetworkButton
} from "./chunk-C7GC5A22.js";
import "./chunk-5I44PCAO.js";
import "./chunk-WIZNEOT6.js";
import "./chunk-YMURT5TY.js";
import "./chunk-WBA3VVEE.js";
import "./chunk-R73BQVCD.js";
import "./chunk-SOS4N4KZ.js";
import "./chunk-T4H57LAF.js";
...
import {
  ...
  LoggerUtil,
  TokenUtil
} from "./chunk-CBHM7Y5H.js";
import "./chunk-LYPHFLBP.js";
import "./chunk-E6ZCHTLV.js";
import "./chunk-JSBTCZYF.js";
import "./chunk-MMJKBRIA.js";
import "./chunk-Z376CSKY.js";
import "./chunk-E5MRS743.js";
import "./chunk-N4Y2SELR.js";
import "./chunk-6QOWD2HI.js";
import "./chunk-NVZHY4BK.js";
import "./chunk-CCZS2YOT.js";
import "./chunk-SAE76EAL.js";
import "./chunk-LD4QFRZW.js";
import "./chunk-MC3RFJPV.js";
import "./chunk-YGZJKVRD.js";
import "./chunk-GB5TBOFG.js";
import "./chunk-SVJBIPFE.js";
import "./chunk-DRU33PMP.js";
import "./chunk-HNB35IZC.js";
import "./chunk-D6H7XJQ6.js";
import "./chunk-FS3CSUOV.js";
import "./chunk-3EJC2A4D.js";
import "./chunk-CGXHVTOC.js";
import "./chunk-FQ6RD344.js";
import "./chunk-W3OYL3X5.js";
import "./chunk-AZ52YB4W.js";
import "./chunk-RTHONNVU.js";
import "./chunk-HCUENXT4.js";
import {
  AdapterBlueprint,
  AlertController,
  ConnectorUtil,
...
import {
  ...
  snapshot,
  subscribe
} from "./chunk-VWVXUFR4.js";
import "./chunk-BP5IDLW3.js";
import {
  toHex
} from "./chunk-CM3PPV3C.js";
import "./chunk-ESJCPN2B.js";
import "./chunk-QMDVOU32.js";
import {
  require_react
} from "./chunk-QUTVZBXY.js";
import "./chunk-MJZIFCLK.js";
import {
  __toESM
...
var AppKitBaseClient = class {
  ...
  async initialize(options) {
    ...
    if (((_e = OptionsController.state.features) == null ? void 0 : _e.reownAuthentication) || ((_f = OptionsController.state.remoteFeatures) == null ? void 0 : _f.reownAuthentication)) {
      const { ReownAuthentication } = await import("./features-5YEI5O6J.js");
...
var AppKit = class extends AppKitBaseClient {
  ...
  async loadModalComponents(features, remoteFeatures) {
    ...
    if (usingEmbeddedWallet) {
      featureImportPromises.push(import("./embedded-wallet-UJHPNUED.js"));
    }
    if (remoteFeatures.email) {
      featureImportPromises.push(import("./email-PXYIARO5.js"));
    }
    if (remoteFeatures.socials) {
      featureImportPromises.push(import("./socials-WRBFDUDI.js"));
    }
    if (remoteFeatures.swaps && remoteFeatures.swaps.length > 0) {
      featureImportPromises.push(import("./swaps-6ZULHV6O.js"));
    }
    if (features.send) {
      featureImportPromises.push(import("./send-QCEUZ3QD.js"));
    }
    if (features.receive) {
      featureImportPromises.push(import("./receive-PMVLOSDX.js"));
    }
    if (remoteFeatures.onramp && remoteFeatures.onramp.length > 0) {
      featureImportPromises.push(import("./onramp-R5CEMCSW.js"));
    }
    if (remoteFeatures.payWithExchange) {
      featureImportPromises.push(import("./pay-with-exchange-EVAJ54QJ.js"));
    }
    if (remoteFeatures.activity) {
      featureImportPromises.push(import("./transactions-CUVOH2OT.js"));
    }
    if (features.pay || remoteFeatures.payments) {
      featureImportPromises.push(import("./exports-WYGBMDCK.js"));
    }
    if (remoteFeatures.emailCapture) {
      featureImportPromises.push(import("./data-capture-PSKIVIO2.js"));
    }
    await Promise.all([
      ...featureImportPromises,
      import("./exports-JEKGRXVO.js"),
      import("./w3m-modal-32H2KEKE.js")
    ]);
  }
};
