import {
  ...
  AppKitConnectButton,
  AppKitNetworkButton
} from "./chunk-DQUUOQWO.js";
import "./chunk-KPGABP6B.js";
import "./chunk-KERAYCI5.js";
import "./chunk-DUOZKOLH.js";
import "./chunk-NQ6BF27U.js";
import "./chunk-B654GQDQ.js";
import "./chunk-HESWNTVD.js";
import "./chunk-NTVAAOK2.js";
import "./chunk-N66XL6Y3.js";
import "./chunk-4YNUJIMT.js";
import "./chunk-QCWUE6YR.js";
import "./chunk-W4VADXYJ.js";
import "./chunk-ZZA476CG.js";
import "./chunk-AEOTM3A4.js";
import "./chunk-YXYHHU7G.js";
import "./chunk-6QOWD2HI.js";
import "./chunk-LN7ENJYG.js";
import "./chunk-XY5V7YKV.js";
import "./chunk-J4GZJE42.js";
import "./chunk-TBBA35OL.js";
import "./chunk-BYWC7C65.js";
...
import {
  ...
  LoggerUtil,
  TokenUtil
} from "./chunk-DIJJJGBV.js";
import "./chunk-2D6NCKYX.js";
import "./chunk-T5JY63JJ.js";
import "./chunk-HNB35IZC.js";
import "./chunk-7CIEGGLI.js";
import "./chunk-LD4QFRZW.js";
import "./chunk-AT6Z4WQX.js";
import "./chunk-FS3CSUOV.js";
import "./chunk-JIUXNBYV.js";
import "./chunk-HKJITDEX.js";
import "./chunk-CGXHVTOC.js";
import "./chunk-XREULQVO.js";
import "./chunk-NG4P7WTU.js";
import "./chunk-UJNISETR.js";
import "./chunk-P2X2B6N2.js";
import {
  AdapterBlueprint,
  AlertController,
  ConnectorUtil,
...
import {
  ...
  snapshot,
  subscribe
} from "./chunk-OEVXY3X2.js";
import "./chunk-MJZIFCLK.js";
import "./chunk-KTUPQ6IN.js";
...
var AppKitBaseClient = class {
  ...
  async initialize(options) {
    ...
    if (((_e = OptionsController.state.features) == null ? void 0 : _e.reownAuthentication) || ((_f = OptionsController.state.remoteFeatures) == null ? void 0 : _f.reownAuthentication)) {
      const { ReownAuthentication } = await import("./features-ZJOKK2TZ.js");
...
var AppKit = class extends AppKitBaseClient {
  ...
  async loadModalComponents(features, remoteFeatures) {
    ...
    if (usingEmbeddedWallet) {
      featureImportPromises.push(import("./embedded-wallet-CMWJ6SQR.js"));
    }
    if (remoteFeatures.email) {
      featureImportPromises.push(import("./email-HCJXPEBW.js"));
    }
    if (remoteFeatures.socials) {
      featureImportPromises.push(import("./socials-AEWBABAY.js"));
    }
    if (remoteFeatures.swaps && remoteFeatures.swaps.length > 0) {
      featureImportPromises.push(import("./swaps-6I6BQCFU.js"));
    }
    if (features.send) {
      featureImportPromises.push(import("./send-464BBZGC.js"));
    }
    if (features.receive) {
      featureImportPromises.push(import("./receive-AHHD2GCY.js"));
    }
    if (remoteFeatures.onramp && remoteFeatures.onramp.length > 0) {
      featureImportPromises.push(import("./onramp-JCZPKO2N.js"));
    }
    if (remoteFeatures.payWithExchange) {
      featureImportPromises.push(import("./pay-with-exchange-IE2NAG5T.js"));
    }
    if (remoteFeatures.activity) {
      featureImportPromises.push(import("./transactions-3TJ4JHKN.js"));
    }
    if (features.pay || remoteFeatures.payments) {
      featureImportPromises.push(import("./exports-Z6FCIADL.js"));
    }
    if (remoteFeatures.emailCapture) {
      featureImportPromises.push(import("./data-capture-4LA762D7.js"));
    }
    await Promise.all([
      ...featureImportPromises,
      import("./exports-IPFV32H4.js"),
      import("./w3m-modal-VVTDJOVL.js")
    ]);
  }
};
