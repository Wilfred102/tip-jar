...
import { ClarityValue } from '@stacks/transactions-v6/dist/clarity';
import { FungibleConditionCode, NonFungibleConditionCode } from '@stacks/transactions-v6/dist/constants';
import { NonFungiblePostCondition } from '@stacks/transactions-v6/dist/postcondition-types';
...
declare class PartialPcFtWithCode {
    ...
    ustx(): import("@stacks/transactions-v6/dist/postcondition-types").STXPostCondition;
    ft(contractId: ContractIdString, tokenName: string): import("@stacks/transactions-v6/dist/postcondition-types").FungiblePostCondition;
}
