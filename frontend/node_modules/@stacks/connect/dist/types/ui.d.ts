...
import { ContractCallOptions, ContractDeployOptions, ProfileUpdateRequestOptions, PsbtRequestOptions, STXTransferOptions, SignatureRequestOptions, StacksProvider, StructuredDataSignatureRequestOptions, TransactionOptions } from '@stacks/connect/dist/types/types';
...
export declare const showSignTransaction: (options: import("@stacks/connect/dist/types/types").SignTransactionOptionBase, provider?: StacksProvider) => any;
